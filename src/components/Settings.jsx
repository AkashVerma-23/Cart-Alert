  ...
  return (
    <div className="settings">
      ...
      <div className="settings-section">
        ...
        <p>
          Shop Reminder helps you remember what items to buy when you're near
          relevant stores. The app uses your device's location and compares it
          with nearby store locations to send you timely reminders.
        </p>
        <p>
